...
<html lang="python" data-content_root="../../../../../../" >
  ...
  <head>
    ...
    <title>A guide to masked arrays in NumPy &#8212; gondola 0.12.0 documentation</title>
...
<link rel="preload" as="script" href="../../../../../../_static/scripts/pydata-sphinx-theme.js?digest=8878045cc6db502f8baf" />
    ...
    <script>DOCUMENTATION_OPTIONS.pagename = '.venv/lib64/python3.12/site-packages/numpy/ma/README';</script>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="ellipsis">A guide to masked arrays in NumPy</span></li>
  </ul>
</nav>
</div>
...
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#revision-notes">Revision notes</a></li>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../../../../../../_sources/.venv/lib64/python3.12/site-packages/numpy/ma/README.rst.txt"
