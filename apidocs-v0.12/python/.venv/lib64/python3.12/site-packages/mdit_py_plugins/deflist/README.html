...
<html lang="python" data-content_root="../../../../../../" >
  ...
  <head>
    ...
    <title>markdown-it-deflist &#8212; gondola 0.12.0 documentation</title>
...
<nav aria-label="Breadcrumb" class="d-print-none">
  <ul class="bd-breadcrumbs">
    ...
    <li class="breadcrumb-item active" aria-current="page"><span class="ellipsis">markdown-it-deflist</span></li>
  </ul>
</nav>
</div>
...
<li class="toc-h2 nav-item toc-entry"><a class="reference internal nav-link" href="#license">License</a></li>
  ...
  <div role="note" aria-label="source link">
    ...
    <ul class="this-page-menu">
      <li><a href="../../../../../../_sources/.venv/lib64/python3.12/site-packages/mdit_py_plugins/deflist/README.md.txt"
