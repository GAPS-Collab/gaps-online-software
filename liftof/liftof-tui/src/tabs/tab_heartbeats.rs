...
pub struct HeartBeatTab {
  ...
  last_evb       : Option<EventBuilderHB>,
  last_mtb       : Option<MasterTriggerHB>,
  last_gds       : Option<DataSinkHB>,
      ...
      Ok(pack)    => {
        ...
        match pack.packet_type {
          TofPacketType::MasterTriggerHB=> {
            let hb : MasterTriggerHB = pack.unpack()?;
          ...
          TofPacketType::EventBuilderHB   => {
            let hb : EventBuilderHB = pack.unpack()?;
