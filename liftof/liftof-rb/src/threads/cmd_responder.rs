//! React to commands while running. This feature has been stripped down, due to 
//! a change in philosophy - whenever a setting is changed, a new run (and thus 
//! a new config file) should be created.
//!
//! However, there are some things which still need to be done during runtime, e.g.
