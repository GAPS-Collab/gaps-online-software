  ...
  for (auto const &p : packets) {
	...
	/*  if (TCFDS[324] < 90.0 || TCFDS[325] < 90.0) {
	    ...
	    std::ofstream file2;
            ...
            std::ofstream myfile;
            myfile.open ("RB49_conf2_swap_laxreq.csv", std::ios::app);
            myfile << evt_ctr << "," << "U";
            myfile << "," << TCFDS[432] << "," << TCFDS[433] << std::endl;
            myfile.close();
	  }

	if (IsHit[436] && IsHit[437]) {
        ...
        /*  if (TCFDS[324] < 90.0 || TCFDS[325] < 90.0) {
            ...
            myfile.open ("RB49_conf2_swap_laxreq.csv", std::ios::app);
            myfile << evt_ctr << "," << "D";
            myfile << "," << TCFDS[436] << "," << TCFDS[437] << std::endl;
            myfile.close();
          }
