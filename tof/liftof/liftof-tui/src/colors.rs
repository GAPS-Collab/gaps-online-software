...
// Default theme, everything Black+White
#[derive(Debug, Copy, Clone)]
pub struct LiftofTuiTheme {
}
...
impl ColorTheme for LiftofTuiTheme {
  const C0 : Color = Color::Black; 
  const C1 : Color = Color::White; 
  const C2 : Color = Color::Black; 
  const C3 : Color = Color::White; 
  ...
  fn style(&self) -> Style {
    Style::default().bg(Self::C0).fg(Self::C3)
  }

  fn style_soft(&self) -> Style {
    Style::default().bg(Self::C1).fg(Self::C2)
  }

  fn highlight(&self) -> Style {
    Style::default().bg(Self::HC).fg(Self::C3)
  }
  ...
  fn background(&self) -> Style {
    Style::default().bg(Self::C0)
  }
}

// A lighter, bluish theme
#[derive(Debug, Copy, Clone)]
pub struct LiftofTuiThemeOmilu {
  pub bg_color1  : Option<Color>,
  pub bg_color2  : Option<Color>,
  pub fg_color1  : Option<Color>,
  pub fg_color2  : Option<Color>,
  pub hi_color   : Option<Color>,
  pub is_changed : bool,
}

impl LiftofTuiThemeOmilu {
...
impl ColorTheme for LiftofTuiThemeOmilu{
  const C0 : Color = Color::Rgb(5, 59, 80);
  const C1 : Color = Color::Rgb(23, 107, 135);
  const C2 : Color = Color::Rgb(100, 204, 197);
  const C3 : Color = Color::Rgb(238, 238, 238);

  const HC : Color = Color::Rgb(225, 170, 116);
...
//pub struct ColorPaletteDune {
//}
//
//impl ColorPaletteDune {
//  pub fn new() -> Self {
//    Self {}
//  }
//}
//
//impl Palette for ColorPaletteDune {
//  const bg_dark  : Color = Color::Rgb(223,135,53); 
//  const bg_light : Color = Color::Rgb(244,193,110); 
//  const fg_dark  : Color = Color::Rgb(181,164,146); 
//  const fg_light : Color = Color::Rgb(161,18,37); 
//}
//
