...
void Waveform::SetPedRange(float range) {
  ...
  if (bin_range < 0 || bin_range > wf_size) {
    ...
    char txt[1000];
    std::cout << "SetPedRange:  Range goes beyond waveform." << std::endl;
...
void Waveform::SetPedBegin(float begin)
{
  ...
  if (begin_bin < 0)
  {
      std::cout << "Unable to set a negative pedestal beginning." << std::endl;
  }
  else if (begin_bin+wf_ped_range > wf_size)
  {
    char txt[1000];
    std::cout << "Starting too far into waveform." << std::endl;
...
int Waveform::Time2Bin(float t_ns){
  ...
  std::cout << "Did not find a bin corresponding to the given time." << std::endl;
  return (-1);
}
////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////
