"""
Session wide elements to cache plots/histograms, memroize app
state etc.
"""
...
class GanderHist:
    ...
    def __init__(self, bins):
        self.histo = d.histogram.hist1d(bins)
...
def gander_plot(h          : d.histogram.hist1d,
    ...
    if gauss_fit:
        ...
        ax.text(text_xpos,0.75, f'$\mu$   = {model.best_fit_params[0]:.2f}', transform=fig.transFigure)
