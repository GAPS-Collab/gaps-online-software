...
./create_trk_db_flight.py --coordinates ../master-spreadsheet/tracker-from-sd.json --pedestals ../tracker-calibration/pedestal_LDB_9December.txt --tracker-mask  ../tracker-calibration/SiLi_active_chs_241207.txt 
