...
export PYTHONPATH=$PYTHONPATH:/srv/gaps/gaps-online-software/install/gaps-online-sw-v0.8/python:/srv/gaps/gaps-online-software/install/gaps-online-sw-v0.8/gaps-db/gaps_db
...
echo -e "********************************************"
echo -e " => software repositories:"
echo -e "    - https://uhhepvcs.phys.hawaii.edu/Achim/gaps-online-software"
